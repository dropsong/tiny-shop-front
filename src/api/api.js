...
// let host = 'http://192.168.19.130:8000';
let local_host = 'http://127.0.0.1:8000';
// let local_host = 'http://47.115.45.50:8000';
// let local_host = 'http://149.129.53.199:8000';
//获取商品类别信息
...
//获取用户信息
export const getUserDetail = () => { return axios.get(`${local_host}/users/9/`) }

//修改用户信息
export const updateUserInfo = params => { return axios.patch(`${local_host}/users/9/`, params) }
